...
echo "Setting fmod to file://${WIN_SCRIPT_DIR//\\//}/artifacts/fmodstudio-2.02.23-windows64-242661809.tar.bz2"
autobuild installables edit fmodstudio platform=windows64 hash=f5844bc284eb47cd3e0642175eba80f1 url=file://${WIN_SCRIPT_DIR//\\//}/artifacts/fmodstudio-2.02.23-windows64-242661809.tar.bz2
