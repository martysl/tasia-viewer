...
void LLFloaterTexturePicker::draw()
{
	...
	getChildView("show_folders_check")->setEnabled(mActive && mCanApplyImmediately && (bypass_perms || !mNoCopyTextureSelected));
	...
	if( mOwner ) 
	{
		...
		mTransparentBtn->setEnabled(mImageAssetID != mTransparentImageAssetID || mTentative); // <FS:PP> FIRE-5082: "Transparent" button in Texture Panel
		LLFloater::draw();
