...
if (WINDOWS)
    ...
    target_link_libraries( ll::expat  INTERFACE ${ARCH_PREBUILT_DIRS_RELEASE}/libexpat.lib)
else ()
    target_link_libraries( ll::expat  INTERFACE ${ARCH_PREBUILT_DIRS_RELEASE}/libexpat.a)
endif ()
